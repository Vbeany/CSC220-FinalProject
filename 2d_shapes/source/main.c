...
//---------------------------------------------------------------------------------
	...
	u32 clrPurple  = C2D_Color32(0xFF, 0x00, 0xFF, 0xFF);
	...
	while (aptMainLoop())
	{
		...
		C2D_DrawTriangle(150 / 2, SCREEN_HEIGHT - 50, clrWhite, 
			100,  SCREEN_HEIGHT, clrTri1,
			150, SCREEN_HEIGHT, clrTri2, 10);
		
		C2D_DrawRectangle(SCREEN_WIDTH - 40, 0, 0, 50, 50, clrRec1, clrRec2, clrRec3, clrRec4);
		...
		C2D_DrawEllipse(0, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, clrCircle1, clrCircle2, clrCircle3, clrPurple);
		C2D_DrawCircle(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0, 50, clrCircle3, clrPurple, clrCircle1, clrCircle2);
		C2D_DrawCircle(25, 25, 0, 25, 
			clrRed, clrBlue, clrPink, clrPink);
